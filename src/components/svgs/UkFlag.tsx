...
export const UkFlag = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g fill='#fff'>
      <path d='M40.5 26h20.8c-.3-1.4-.7-2.7-1.1-4h-5.1l3.9-2.9c-.8-1.7-1.7-3.2-2.8-4.7L46 22h-4v-2l11.7-8.6-1.4-1.4L42 17.5V3.7c-1.3-.5-2.6-.8-4-1.1V26h2.5M2.6 26H26V2.6c-1.4.3-2.7.7-4 1.1v13.8L11.7 10c-1.4 1.3-2.6 2.7-3.8 4.2L18.6 22h-6.8l-6.1-4.5c-.3.5-.6 1.1-.8 1.6L8.8 22H3.7c-.4 1.3-.8 2.6-1.1 4' />
    </g>
    <g fill='#ed4c5c'>
      <path d='M56.3 14.4c-.8-1.1-1.6-2.1-2.5-3.1L42 19.9v2h4l10.3-7.5M18.5 22 7.9 14.2c-.4.5-.7 1-1.1 1.5-.1.1-.1.2-.2.2-.3.5-.7 1.1-1 1.6l6.1 4.5h6.8' />
